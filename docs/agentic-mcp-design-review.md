...
|---|---|---|---|
| **Tools** | Model-controlled | Actions & queries | ✅ 30 tools with structured output, annotations, and permission gating |
...
| **Full Access** | All 30 tools, no rate limits | Trusted workflows with full autonomy |
